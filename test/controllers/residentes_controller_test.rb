...
class ResidentesControllerTest < ActionController::TestCase
  ...
  test "should create residente" do
    assert_difference('Residente.count') do
      post :create, residente: { apartamento_id: @residente.apartamento_id, apellido: @residente.apellido, fecha_nacimiento: @residente.fecha_nacimiento, identificacion: @residente.identificacion, nombre: @residente.nombre }
    end
  ...
  test "should update residente" do
    patch :update, id: @residente, residente: { apartamento_id: @residente.apartamento_id, apellido: @residente.apellido, fecha_nacimiento: @residente.fecha_nacimiento, identificacion: @residente.identificacion, nombre: @residente.nombre }
    assert_redirected_to residente_path(assigns(:residente))
  end
